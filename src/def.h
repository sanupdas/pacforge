...
#define IGMP_HDR_LEN		8			/* IGMP header length */
...
#ifndef IPPROTO_IGMP
#define IPPROTO_IGMP        2           /* internet group membership protocol  */
#endif
 ...
 */
struct igmphdr {
    u_char  		type;   	        /* igmp header type */
#define IGMP_MEMBERSHIP_QUERY           0x11    /* membership query */
#define IGMP_V1_MEMBERSHIP_REPORT       0x12    /* Ver. 1 membership report */
#define IGMP_V2_MEMBERSHIP_REPORT       0x16    /* Ver. 2 membership report */
#define IGMP_V2_LEAVE_GROUP             0x17    /* Leave-group message */
    u_char  		code;   		    /* igmp code/mrt */
    u_short 		checksum;           /* igmp header checksum */
...
struct igmpopt {
	u_char  		igmp_new_type;
    u_char          ih_type_flag;
    u_char  		igmp_new_mrt;
    u_char          ih_mrt_flag;
    u_short 		igmp_new_checksum;
    struct in_addr 	igmp_old_group;  	/* igmp old group address */
    struct in_addr 	igmp_new_group;  	/* igmp new group address */
    u_char			ih_group_flag;
};
